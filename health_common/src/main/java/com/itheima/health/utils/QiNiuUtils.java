...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "x3_HyiLLc20UK3Pj5yWxVYWuLj0XSkeZQsM3-jXC";
    private static final String SECRETKEY = "-Zqdy1_Jeqk3-v7t13ebMTTGzNdybqgT3RwRECIF";
    private static final String BUCKET = "hefei104";
    public static final String DOMAIN= "http://qkawn0rlb.hn-bkt.clouddn.com/";
